...
INSTALLED_APPS = [
    # Django Channels должен быть первым
    'daphne',
...
ASGI_APPLICATION = 'alfa.asgi.application'
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 20,
    'EXCEPTION_HANDLER': 'users.utils.exception_handler.custom_exception_handler',
}
